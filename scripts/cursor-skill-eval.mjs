...
const EVALUATOR_INPUTS = Object.freeze([
  ...
  'tests/codex-client-integration.test.mjs', 'tests/codex-request-measurement.mjs', 'tests/codex-client-oracle-support.mjs', 'tests/release-e2e.test.mjs', 'tests/release-e2e-oracle-support.mjs', 'tests/fixtures/accelerate-turn-timeout.mjs',
